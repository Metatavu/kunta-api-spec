...
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaJAXRSSpecServerCodegen", date = "2019-03-11T07:39:03.762+02:00")
...
public abstract class OrganizationsApi extends AbstractApi {
    ...
    public abstract Response listOrganizationEnvironmentalWarnings(@PathParam("organizationId") String organizationId,@QueryParam("firstResult") Integer firstResult,@QueryParam("contexts") String contexts,@QueryParam("startBefore") String startBefore,@QueryParam("startAfter") String startAfter,@QueryParam("maxResults") Integer maxResults,@QueryParam("sortBy") String sortBy,@QueryParam("sortDir") String sortDir,@Context Request request);
