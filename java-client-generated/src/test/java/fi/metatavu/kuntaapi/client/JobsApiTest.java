...
public class JobsApiTest {
     ...
     */
    @Test
    public void findOrganizationJobTest() throws ApiException {
        String organizationId = null;
        String jobId = null;
        // Job response = api.findOrganizationJob(organizationId, jobId);
     ...
     */
    @Test
    public void listOrganizationJobsTest() throws ApiException {
        String organizationId = null;
        String sortBy = null;
        String sortDir = null;
        Long firstResult = null;
        Long maxResults = null;
        // List<Job> response = api.listOrganizationJobs(organizationId, sortBy, sortDir, firstResult, maxResults);
