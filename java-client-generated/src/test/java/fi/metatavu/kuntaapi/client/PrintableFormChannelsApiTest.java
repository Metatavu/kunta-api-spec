...
/**
 * API tests for PrintableFormChannelsApi
 */
public class PrintableFormChannelsApiTest {

    private final PrintableFormChannelsApi api = new PrintableFormChannelsApi();
