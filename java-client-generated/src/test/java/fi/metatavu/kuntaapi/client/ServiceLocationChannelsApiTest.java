...
/**
 * API tests for ServiceLocationChannelsApi
 */
public class ServiceLocationChannelsApiTest {

    private final ServiceLocationChannelsApi api = new ServiceLocationChannelsApi();
