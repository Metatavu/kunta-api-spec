...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KuntaApiClient.ApiClient = factory(root.superagent);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://demo.kuntaapi.fi/v1
     */
    this.basePath = 'https://demo.kuntaapi.fi/v1'.replace(/\/+$/, '');
    ...
    return new Promise(function(resolve, reject) {
      ...
      if (_this.failsafeCache && _this.cacheableMethods.indexOf(httpMethod) > -1) {
        requestTimeOut = setTimeout(function() {
          var cacheKey = _this.cacheUtils.keygen(request);
          _this.failsafeCache.get(cacheKey, function(cacheErr, failsafeData) {
      ...
      request.end(function(error, response) {
        ...
        if (error) {
          ...
          if (_this.failsafeCache && _this.cacheableMethods.indexOf(httpMethod) > -1) {
            var cacheKey = _this.cacheUtils.keygen(request);
            _this.failsafeCache.set(cacheKey, data);
          }
