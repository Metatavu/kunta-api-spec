...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KuntaApiClient.ServiceChannelSupport = factory(root.KuntaApiClient.ApiClient);
  }
  ...
  /**
   * The ServiceChannelSupport model module.
   * @module model/ServiceChannelSupport
   * @version 0.0.7
   */

  /**
   * Constructs a new <code>ServiceChannelSupport</code>.
   * @alias module:model/ServiceChannelSupport
   * @class
   */
  ...
  /**
   * Constructs a <code>ServiceChannelSupport</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ServiceChannelSupport} obj Optional instance to populate.
   * @return {module:model/ServiceChannelSupport} The populated <code>ServiceChannelSupport</code> instance.
   */
