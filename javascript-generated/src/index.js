...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccessibilityContactInfo', 'model/AccessibilitySentence', 'model/AccessibilitySentenceValue', 'model/Address', 'model/AddressEntrance', 'model/Agency', 'model/Announcement', 'model/Area', 'model/Attachment', 'model/BadRequest', 'model/Banner', 'model/Code', 'model/CodeExtra', 'model/Contact', 'model/ContactPhone', 'model/ContactStatus', 'model/Coordinate', 'model/Coordinates', 'model/DailyOpeningTime', 'model/ElectronicServiceChannel', 'model/Email', 'model/Emergency', 'model/EmergencySource', 'model/EnvironmentalWarning', 'model/Event', 'model/FileDef', 'model/Forbidden', 'model/Fragment', 'model/Incident', 'model/InternalServerError', 'model/Job', 'model/Law', 'model/LocalizedValue', 'model/Menu', 'model/MenuItem', 'model/Municipality', 'model/NameTypeByLanguage', 'model/NewsArticle', 'model/NotFound', 'model/NotImplemented', 'model/OntologyItem', 'model/Organization', 'model/OrganizationService', 'model/OrganizationSetting', 'model/Page', 'model/PageMeta', 'model/Phone', 'model/PhoneServiceChannel', 'model/PrintableFormServiceChannel', 'model/Route', 'model/Schedule', 'model/ScheduleException', 'model/Service', 'model/ServiceChannelAttachment', 'model/ServiceHour', 'model/ServiceLocationServiceChannel', 'model/ServiceOrganization', 'model/ServiceVoucher', 'model/Shortlink', 'model/Stop', 'model/StopTime', 'model/Tile', 'model/Trip', 'model/WebPage', 'model/WebPageServiceChannel', 'api/AnnouncementsApi', 'api/BannersApi', 'api/CodesApi', 'api/ContactsApi', 'api/ElectronicChannelsApi', 'api/ElectronicServiceChannelsApi', 'api/EmergenciesApi', 'api/EnvironmentalWarningsApi', 'api/EventsApi', 'api/FilesApi', 'api/FragmentsApi', 'api/IncidentsApi', 'api/JobsApi', 'api/MenusApi', 'api/NewsApi', 'api/OrganizationsApi', 'api/PagesApi', 'api/PhoneChannelsApi', 'api/PhoneServiceChannelsApi', 'api/PrintableFormChannelsApi', 'api/PrintableFormServiceChannelsApi', 'api/PublicTransportApi', 'api/ServiceChannelsApi', 'api/ServiceLocationChannelsApi', 'api/ServiceLocationServiceChannelsApi', 'api/ServicesApi', 'api/SettingsApi', 'api/ShortlinksApi', 'api/TilesApi', 'api/WebPageChannelsApi', 'api/WebPageServiceChannelsApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/AccessibilityContactInfo'), require('./model/AccessibilitySentence'), require('./model/AccessibilitySentenceValue'), require('./model/Address'), require('./model/AddressEntrance'), require('./model/Agency'), require('./model/Announcement'), require('./model/Area'), require('./model/Attachment'), require('./model/BadRequest'), require('./model/Banner'), require('./model/Code'), require('./model/CodeExtra'), require('./model/Contact'), require('./model/ContactPhone'), require('./model/ContactStatus'), require('./model/Coordinate'), require('./model/Coordinates'), require('./model/DailyOpeningTime'), require('./model/ElectronicServiceChannel'), require('./model/Email'), require('./model/Emergency'), require('./model/EmergencySource'), require('./model/EnvironmentalWarning'), require('./model/Event'), require('./model/FileDef'), require('./model/Forbidden'), require('./model/Fragment'), require('./model/Incident'), require('./model/InternalServerError'), require('./model/Job'), require('./model/Law'), require('./model/LocalizedValue'), require('./model/Menu'), require('./model/MenuItem'), require('./model/Municipality'), require('./model/NameTypeByLanguage'), require('./model/NewsArticle'), require('./model/NotFound'), require('./model/NotImplemented'), require('./model/OntologyItem'), require('./model/Organization'), require('./model/OrganizationService'), require('./model/OrganizationSetting'), require('./model/Page'), require('./model/PageMeta'), require('./model/Phone'), require('./model/PhoneServiceChannel'), require('./model/PrintableFormServiceChannel'), require('./model/Route'), require('./model/Schedule'), require('./model/ScheduleException'), require('./model/Service'), require('./model/ServiceChannelAttachment'), require('./model/ServiceHour'), require('./model/ServiceLocationServiceChannel'), require('./model/ServiceOrganization'), require('./model/ServiceVoucher'), require('./model/Shortlink'), require('./model/Stop'), require('./model/StopTime'), require('./model/Tile'), require('./model/Trip'), require('./model/WebPage'), require('./model/WebPageServiceChannel'), require('./api/AnnouncementsApi'), require('./api/BannersApi'), require('./api/CodesApi'), require('./api/ContactsApi'), require('./api/ElectronicChannelsApi'), require('./api/ElectronicServiceChannelsApi'), require('./api/EmergenciesApi'), require('./api/EnvironmentalWarningsApi'), require('./api/EventsApi'), require('./api/FilesApi'), require('./api/FragmentsApi'), require('./api/IncidentsApi'), require('./api/JobsApi'), require('./api/MenusApi'), require('./api/NewsApi'), require('./api/OrganizationsApi'), require('./api/PagesApi'), require('./api/PhoneChannelsApi'), require('./api/PhoneServiceChannelsApi'), require('./api/PrintableFormChannelsApi'), require('./api/PrintableFormServiceChannelsApi'), require('./api/PublicTransportApi'), require('./api/ServiceChannelsApi'), require('./api/ServiceLocationChannelsApi'), require('./api/ServiceLocationServiceChannelsApi'), require('./api/ServicesApi'), require('./api/SettingsApi'), require('./api/ShortlinksApi'), require('./api/TilesApi'), require('./api/WebPageChannelsApi'), require('./api/WebPageServiceChannelsApi'));
  }
}(function(ApiClient, AccessibilityContactInfo, AccessibilitySentence, AccessibilitySentenceValue, Address, AddressEntrance, Agency, Announcement, Area, Attachment, BadRequest, Banner, Code, CodeExtra, Contact, ContactPhone, ContactStatus, Coordinate, Coordinates, DailyOpeningTime, ElectronicServiceChannel, Email, Emergency, EmergencySource, EnvironmentalWarning, Event, FileDef, Forbidden, Fragment, Incident, InternalServerError, Job, Law, LocalizedValue, Menu, MenuItem, Municipality, NameTypeByLanguage, NewsArticle, NotFound, NotImplemented, OntologyItem, Organization, OrganizationService, OrganizationSetting, Page, PageMeta, Phone, PhoneServiceChannel, PrintableFormServiceChannel, Route, Schedule, ScheduleException, Service, ServiceChannelAttachment, ServiceHour, ServiceLocationServiceChannel, ServiceOrganization, ServiceVoucher, Shortlink, Stop, StopTime, Tile, Trip, WebPage, WebPageServiceChannel, AnnouncementsApi, BannersApi, CodesApi, ContactsApi, ElectronicChannelsApi, ElectronicServiceChannelsApi, EmergenciesApi, EnvironmentalWarningsApi, EventsApi, FilesApi, FragmentsApi, IncidentsApi, JobsApi, MenusApi, NewsApi, OrganizationsApi, PagesApi, PhoneChannelsApi, PhoneServiceChannelsApi, PrintableFormChannelsApi, PrintableFormServiceChannelsApi, PublicTransportApi, ServiceChannelsApi, ServiceLocationChannelsApi, ServiceLocationServiceChannelsApi, ServicesApi, SettingsApi, ShortlinksApi, TilesApi, WebPageChannelsApi, WebPageServiceChannelsApi) {
  'use strict';
  ...
  var exports = {
    ...
    ApiClient: ApiClient,
    /**
     * The AccessibilityContactInfo model constructor.
     * @property {module:model/AccessibilityContactInfo}
     */
    AccessibilityContactInfo: AccessibilityContactInfo,
    /**
     * The AccessibilitySentence model constructor.
     * @property {module:model/AccessibilitySentence}
     */
    AccessibilitySentence: AccessibilitySentence,
    /**
     * The AccessibilitySentenceValue model constructor.
     * @property {module:model/AccessibilitySentenceValue}
     */
    AccessibilitySentenceValue: AccessibilitySentenceValue,
    /**
    ...
    Address: Address,
    /**
     * The AddressEntrance model constructor.
     * @property {module:model/AddressEntrance}
     */
    ...
    /**
     * The EnvironmentalWarning model constructor.
     * @property {module:model/EnvironmentalWarning}
     */
    ...
    /**
     * The ServiceVoucher model constructor.
     * @property {module:model/ServiceVoucher}
     */
    ...
    /**
     * The EnvironmentalWarningsApi service constructor.
     * @property {module:api/EnvironmentalWarningsApi}
     */
    EnvironmentalWarningsApi: EnvironmentalWarningsApi,
    /**
