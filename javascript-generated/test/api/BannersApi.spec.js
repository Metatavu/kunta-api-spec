...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KuntaApiClient.BannersApi();
  });
  ...
  describe('BannersApi', function() {
    describe('findOrganizationBanner', function() {
      it('should call findOrganizationBanner successfully', function(done) {
        //uncomment below and update the code to test findOrganizationBanner
        //instance.findOrganizationBanner(pet, function(error) {
    ...
    describe('listOrganizationBannerImages', function() {
      it('should call listOrganizationBannerImages successfully', function(done) {
        ...
        //instance.listOrganizationBannerImages(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listOrganizationBanners', function() {
      it('should call listOrganizationBanners successfully', function(done) {
        //uncomment below and update the code to test listOrganizationBanners
        //instance.listOrganizationBanners(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
