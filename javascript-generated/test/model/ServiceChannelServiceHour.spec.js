...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KuntaApiClient.ServiceChannelServiceHour();
  });
  ...
  describe('ServiceChannelServiceHour', function() {
    it('should create an instance of ServiceChannelServiceHour', function() {
      // uncomment below and update the code to test ServiceChannelServiceHour
      //var instane = new KuntaApiClient.ServiceChannelServiceHour();
      //expect(instance).to.be.a(KuntaApiClient.ServiceChannelServiceHour);
    });
