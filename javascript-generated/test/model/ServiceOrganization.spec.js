...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KuntaApiClient.ServiceOrganization();
  });
  ...
  describe('ServiceOrganization', function() {
    it('should create an instance of ServiceOrganization', function() {
      // uncomment below and update the code to test ServiceOrganization
      //var instane = new KuntaApiClient.ServiceOrganization();
      //expect(instance).to.be.a(KuntaApiClient.ServiceOrganization);
    });
