...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KuntaApiClient.ServiceChannelCommon();
  });
  ...
  describe('ServiceChannelCommon', function() {
    it('should create an instance of ServiceChannelCommon', function() {
      // uncomment below and update the code to test ServiceChannelCommon
      //var instane = new KuntaApiClient.ServiceChannelCommon();
      //expect(instance).to.be.a(KuntaApiClient.ServiceChannelCommon);
    });
