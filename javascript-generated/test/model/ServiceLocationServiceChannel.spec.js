...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KuntaApiClient.ServiceLocationServiceChannel();
  });
  ...
  describe('ServiceLocationServiceChannel', function() {
    it('should create an instance of ServiceLocationServiceChannel', function() {
      // uncomment below and update the code to test ServiceLocationServiceChannel
      //var instane = new KuntaApiClient.ServiceLocationServiceChannel();
      //expect(instance).to.be.a(KuntaApiClient.ServiceLocationServiceChannel);
    });
