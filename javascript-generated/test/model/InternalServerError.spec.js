...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KuntaApiClient.InternalServerError();
  });
  ...
  describe('InternalServerError', function() {
    it('should create an instance of InternalServerError', function() {
      ...
      //var instane = new KuntaApiClient.InternalServerError();
      //expect(instance).to.be.a(KuntaApiClient.InternalServerError);
    });
