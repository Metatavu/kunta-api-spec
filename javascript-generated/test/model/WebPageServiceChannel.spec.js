...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KuntaApiClient.WebPageServiceChannel();
  });
  ...
  describe('WebPageServiceChannel', function() {
    it('should create an instance of WebPageServiceChannel', function() {
      // uncomment below and update the code to test WebPageServiceChannel
      //var instane = new KuntaApiClient.WebPageServiceChannel();
      //expect(instance).to.be.a(KuntaApiClient.WebPageServiceChannel);
    });
