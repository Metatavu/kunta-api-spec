...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KuntaApiClient.Banner();
  });
  ...
  describe('Banner', function() {
    it('should create an instance of Banner', function() {
      // uncomment below and update the code to test Banner
      //var instane = new KuntaApiClient.Banner();
      //expect(instance).to.be.a(KuntaApiClient.Banner);
    });
