...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KuntaApiClient.ElectronicServiceChannel();
  });
  ...
  describe('ElectronicServiceChannel', function() {
    it('should create an instance of ElectronicServiceChannel', function() {
      // uncomment below and update the code to test ElectronicServiceChannel
      //var instane = new KuntaApiClient.ElectronicServiceChannel();
      //expect(instance).to.be.a(KuntaApiClient.ElectronicServiceChannel);
    });
