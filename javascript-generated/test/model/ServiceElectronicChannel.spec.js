...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KuntaApiClient.ServiceElectronicChannel();
  });
  ...
  describe('ServiceElectronicChannel', function() {
    it('should create an instance of ServiceElectronicChannel', function() {
      // uncomment below and update the code to test ServiceElectronicChannel
      //var instane = new KuntaApiClient.ServiceElectronicChannel();
      //expect(instance).to.be.a(KuntaApiClient.ServiceElectronicChannel);
    });
    ...
    it('should have the property serviceHoursAdditinalInformation (base name: "serviceHoursAdditinalInformation")', function() {
      // uncomment below and update the code to test the property serviceHoursAdditinalInformation
      //var instane = new KuntaApiClient.ServiceElectronicChannel();
      //expect(instance).to.be();
    });
